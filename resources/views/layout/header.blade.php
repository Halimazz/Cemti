    ...
    <nav id="navBar" class="bg-green-600 w-full h-28 py-2 px-4 flex items-center justify-center grow-0">
        <div class="flex flex-row items-center py-2 grow w-full max-w-11xl ml-2">
            ...
            <div id="brandName" class="grow flex flex-row justify-start items-center ml-8">
                <a href="{{ url('home') }}">
                    <p class="font-inter text-3xl ml-8 {{ $page == 'Home' ? 'text-gray-300' : 'text-white hover:text-gray-300 duration-200' }}">Home</p>
                </a>
                <a href="{{ url('how') }}">
                    <p class="font-inter text-3xl ml-8 {{ $page == 'How' ? 'text-gray-300' : 'text-white hover:text-gray-300 duration-200' }}">How it works?</p>
                </a>
                <a href="{{ url('about') }}">
                    <p class="font-inter text-3xl ml-8 {{ $page == 'About' ? 'text-gray-300' : 'text-white hover:text-gray-300 duration-200' }}">About Us</p>
                </a>
            </div>
            <a href="{{ url('login') }}">
